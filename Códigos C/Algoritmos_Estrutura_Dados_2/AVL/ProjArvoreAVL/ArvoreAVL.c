#include <stdio.h>
#include <stdlib.h>
#include "ArvoreAVL.h" //inclui os Protãtipos
...
int insere_ArvAVL(ArvAVL *raiz, int valor){
    int res;
    if(*raiz == NULL){//ãrvore vazia ou nã folha
        struct NO *novo;
...
int remove_ArvAVL(ArvAVL *raiz, int valor){
    ...
    if((*raiz)->info == valor){
        if(((*raiz)->esq == NULL || (*raiz)->dir == NULL)){// nã tem 1 filho ou nenhum
